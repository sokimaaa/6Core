...
@Tag(
    name = "Warehouse creation specification",
...
public interface WarehouseCreationApi {
  ...
  default Flux<ResponseEntity<WarehouseResponse>> createWarehouse(WarehouseRequest request) {
    WarehouseResponse mockProduct = new WarehouseResponse("1002L", "Warehouse address");
    return Flux.just(ResponseEntity.status(HttpStatusCode.valueOf(201)).body(mockProduct));
  }
}
