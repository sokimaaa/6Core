...
@Tag(
    name = "Getting inventory specification",
    description = "REST specification for getting inventory by warehouseId and inventoryId")
public interface InventoryGetApi {
  /**
   * Getting inventory by warehouseId and inventoryId GET
   * /warehouses/{warehouseId}/inventories/{inventoryId}
   *
  ...
  @Operation(
      summary = "Get inventory by warehouseId and inventoryId",
  ...
  default Flux<ResponseEntity<InventoryResponse>> getInventoryByWarehouseIdAndInventoryId(
      String warehouseId, String inventoryId) {
    InventoryResponse mockInventory = new InventoryResponse("2_7", "2", 1);
